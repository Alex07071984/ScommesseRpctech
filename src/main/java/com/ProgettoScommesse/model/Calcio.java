...
public class Calcio
{
	...
	public Calcio(Date data, float ora, String man, int pal, int avv, String sq1, String sq2, float sq1vincente, float pareggio, float sq2vincente)
	{
		super();
		this.data=data;
		this.ora=ora;
	...
	public float getPareggio()
	{
		return pareggio;
	}

	public void setPareggio(float pareggio)
	{
		this.pareggio = pareggio;
	}
